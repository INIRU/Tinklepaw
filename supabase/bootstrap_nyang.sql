...
create table if not exists nyang.app_config (
  ...
  gacha_embed_title text default '🎰 가챠 뽑기',
  gacha_embed_color text default '#5865F2',
  gacha_embed_description text default '현재 포인트: {points}p...',
  gacha_processing_title text default '🎲 뽑는 중...',
  gacha_processing_description text default '{drawCount}회 뽑기를 진행하고 있습니다...',
  gacha_result_title text default '🎉 {drawCount}회 뽑기 결과',
  
  -- Inventory Embed Settings (011)
  inventory_embed_title text default '🎒 인벤토리',
  inventory_embed_color text default '#5865F2',
  inventory_embed_description text default '{user}님의 인벤토리입니다.\n현재 포인트: **{points}p**',

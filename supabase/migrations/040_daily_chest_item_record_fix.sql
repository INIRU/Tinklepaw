...
declare
  ...
  v_item_rarity nyang.gacha_rarity := null;
...
begin
  ...
  if random() * 100.0 < v_item_drop_rate_pct then
    ...
    into v_item_id, v_item_name, v_item_rarity
    from items i
    where
      i.is_active = true
    ...
    if v_item_id is not null then
      ...
      values (p_discord_user_id, v_item_id, 1)
  ...
  values (
    ...
    jsonb_build_object(
      ...
      'item_rarity', v_item_rarity::text,
  ...
  out_reward_item_id := v_item_id;
  out_reward_item_name := v_item_name;
  out_reward_item_rarity := v_item_rarity;

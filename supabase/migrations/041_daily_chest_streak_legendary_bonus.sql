alter table nyang.point_balances
  add column if not exists daily_chest_streak integer not null default 0,
  add column if not exists daily_chest_last_claim_date date;

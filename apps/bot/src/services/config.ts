...
const AppConfigSchema = z.object({
  ...
  stock_news_worker_interval_ms: z.number().nullable().optional(),
  reward_emoji_enabled: z.boolean().default(true),
